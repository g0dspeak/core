...
class Node implements FilesNode {
	...
	public function delete() {
		if($this->getType() === \OCP\Files\FileInfo::TYPE_FILE) {
	...
	public function getMTime() {
		$this->storage->filemtime($this->path);
	}
	...
	public function getPermissions() {
		$this->storage->getPermissions($this->path);
	}
	...
	public function isReadable() {
		$this->storage->isReadable($this->path);
	}
	...
	public function isUpdateable() {
		$this->storage->isUpdatable($this->path);
	}
	...
	public function isDeletable() {
		$this->storage->isDeletable($this->path);
	}
